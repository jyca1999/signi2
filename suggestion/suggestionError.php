...
<html>
  ...
  <? } ?>
    ...
    <div class="container" id="plantMain">
      <div class="error" style="background-color:#D70050;">
        <a href="/plant/suggestionErrorPlant.php">Plant</a>
      </div>
      <div class="error" style="background-color:#00A0E8;">
        <a href="/plant/suggestionErrorStone.php">Stone</a>
      </div>
      <div class="error" style="background-color:#F39700;">
        <a href="/plant/suggestionErrorSite.php">site</a>
      </div>
    </div>
