...
<html>
  ...
  <? } ?>
    ...
    <div class="container" id="plantMain">
      <div class="content" style="background-color:#D70050;">
        <a href="/plant/suggestionContentPlant.php">Plant</a>
      </div>
      <div class="content" style="background-color:#00A0E8;">
        <a href="/plant/suggestionContentStone.php">Stone</a>
      </div>
    </div>
