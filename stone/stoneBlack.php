    ...
    <div>
      <div class="row" id="listRowTop">
        <div class="col-md-2" id="list">
          <a href="/stone/stoneIntroduce.php?name=흑요석">
          <img src="/images/stone/black/obsidian.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
        <div class="col-md-2" id="list">
          <a href="/stone/stoneIntroduce.php?name=전기석">
          <img src="/images/stone/black/tourmaline.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
