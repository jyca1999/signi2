    ...
    <div>
      <div class="row" id="listRowTop">
        <div class="col-md-2" id="list">
          <a href="/stone/stoneIntroduce.php?name=다이아몬드">
          <img src="/images/stone/white/diamond.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
        <div class="col-md-2" id="list">
          <a href="/stone/stoneIntroduce.php?name=오팔">
          <img src="/images/stone/white/opal.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
        <div class="col-md-2" id="list">
          <a href="/stone/stoneIntroduce.php?name=진주">
          <img src="/images/stone/white/pearl.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
