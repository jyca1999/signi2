    ...
    <div>
      <div class="row" id="listRowTop">
        <div class="col-md-2" id="list">
          <a href="/stone/stoneIntroduce.php?name=석류석">
          <img src="/images/stone/red/garnet.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
        <div class="col-md-2" id="list">
          <a href="/stone/stoneIntroduce.php?name=루비">
          <img src="/images/stone/red/rubi.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
