    ...
    <div>
      <div class="row" id="listRowTop">
        <div class="col-md-2" id="list">
          <a href="/plant/plantIntroduce.php?name=벚꽃">
          <img src="/images/plant/spring/cherryblossom.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
        <div class="col-md-2" id="list">
          <a href="/plant/plantIntroduce.php?name=자목련">
          <img src="/images/plant/spring/LilyMagnolia.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
