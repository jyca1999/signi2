    ...
    <div>
      <div class="row" id="listRowTop">
        <div class="col-md-2" id="list">
          <a href="/plant/plantIntroduce.php?name=코스모스">
          <img src="/images/plant/autume/cosmos.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
        <div class="col-md-2" id="list">
          <a href="/plant/plantIntroduce.php?name=방울꽃">
          <img src="/images/plant/autume/Oligantha.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
