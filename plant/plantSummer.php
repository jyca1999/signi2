    ...
    <div>
      <div class="row" id="listRowTop">
        <div class="col-md-2" id="list">
          <a href="/plant/plantIntroduce.php?name=장미">
          <img src="/images/plant/summer/rose.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
        <div class="col-md-2" id="list">
          <a href="/plant/plantIntroduce.php?name=수국">
          <img src="/images/plant/summer/hydrangea.png" class="img-responsive" id="picForSub"/>
          </a>
        </div>
        <div class="col-md-1" id="listBlank">
        </div>
