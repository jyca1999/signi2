...
<html>
  ...
  <script>
    function chk_frm(){
      ...
      if(!document.search.plantNameK.value && !document.search.plantNameE.value){
  ...
  <? } ?>
    ...
    <div class="container" id="search">
      <form class="form-horizontal" action="/plant/forPlantSearch.php" method="post" onsubmit="return chk_frm()" name="search">
      <div class="form-group">
        <label for="plantNameK">한글 표기</label>
        <input type="text" class="form-control" id="plantNameK" name="plantNameK" placeholder="이름을 입력해 주세요.">
        <br>
        <label for="plantNameE">영어 표기</label>
        <input type="text" class="form-control" id="plantNameE" name="plantNameE" placeholder="Please enter the name">
      </div>
      <p style="color:red; font-size:15px;" class="col-sm-9" float="left">
        띄어쓰기는 지원하지 않습니다 ex) cherry blossom (X) cherryblossom(O)
      </p>
      <br>
      <br>
      <br>
